...
function DescargarArchivo(){
    ...
    var n_arc=document.getElementById(get_vent().replace("textarea","a")).text;
    n_arc = n_arc.replace(".cs", "");
    var formato=n_arc +"_"+dd+"_"+mm+"_"+yyyy+"_"+HH+"_"+MM;
    //var formato=get_vent()+"_"+dd+"_"+mm+"_"+yyyy+"_"+HH+"_"+MM;
  
    var nombre=formato+".cs";//nombre del archivo
